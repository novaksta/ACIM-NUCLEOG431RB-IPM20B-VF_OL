...
#define MAX_APPLICATION_SPEED_RPM         9800 /*!< rpm, mechanical */

#define SPEED_LOOP_FREQUENCY_HZ           500 /* Execution rate of speed regulation loop (Hz) */

#define DEFAULT_TARGET_SPEED_RPM          1798
...
#define SW_DEADTIME_NS                    1350 /*!< Dead-time to be inserted
...
#define OV_VOLTAGE_THRESHOLD_V            390 /*!< Over-voltage threshold */
