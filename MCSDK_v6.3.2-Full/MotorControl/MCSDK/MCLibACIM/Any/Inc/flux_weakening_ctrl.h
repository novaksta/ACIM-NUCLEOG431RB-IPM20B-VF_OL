...
/**
  ...
  */
static inline uint16_t FW_GetAvVPercentage(FW_Handle_t *pHandle)
{
...
/**
  ...
  */
static inline uint16_t FW_GetVref(FW_Handle_t *pHandle)
{
#ifdef NULL_PTR_CHECK_FLUX_WEAK
...
/**
  ...
  */
static inline void FW_SetVref(FW_Handle_t *pHandle, uint16_t hNewVref)
{
#ifdef NULL_PTR_CHECK_FLUX_WEAK
  if (NULL == pHandle)
  {
